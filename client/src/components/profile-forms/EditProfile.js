...
const EditProfile = ({profile:{profile, loading}, createProfile, history, getCurrentProfile}) => {
    ...
    return (
        <Fragment>
            ...
            <small className="lead">* - Required field</small>
            <form className="form" onSubmit={e=>onSubmit(e)}>
                <div className="form-group">
                    ...
                    <small className="form-text">Give us an idea of where your are in your career</small>
                </div>
                <div className="form-group">
                    <input type="text" 
                    placeholder="Company"
                ...
                <div className="form-group">
                    ...
                    value={website} 
                    onChange={e=>onChange(e)}/>
                    <small className="form-text">Could be your own or your company website</small>
                </div>
                <div className="form-group">
                    <input type="text" 
                    ...
                    value={location} 
                    onChange={e=>onChange(e)}/>
                    <small className="form-text">City or State</small>
                </div>
                <div className="form-group">
                    <input type="text" 
                    placeholder="*Skills" 
                    ...
                    value={skills} 
                    onChange={e=>onChange(e)}/>
                    <small className="form-text">Please use comma seperated values (eg. HTML,CSS,JS,REACT.JS)</small>
                </div>
                <div className="form-group">
                    <input type="text" 
